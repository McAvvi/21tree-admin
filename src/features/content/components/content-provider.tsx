...
type ContentDialogType = 'addFolder' | 'addTemplate' | 'edit' | 'delete'

type ContentContextType = {
  open: ContentDialogType | null
  setOpen: (str: ContentDialogType | null) => void
  currentRow: ContentItem | null
  setCurrentRow: React.Dispatch<React.SetStateAction<ContentItem | null>>
}
...
export function ContentProvider({ children }: { children: React.ReactNode }) {
  ...
  const [currentRow, setCurrentRow] = useState<ContentItem | null>(null)
